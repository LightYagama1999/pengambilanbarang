function doPost(e) {
  try {
    ...
    var message =
      "Halo, Ada pengambilan barang di Gudang/Warehouse Workshop PPI https://docs.google.com/spreadsheets/d/1wGns6nmPqiFEY9WutHzALfv7qkt1gdxzIp6ARVAhwi0/edit#gid=0\n\nDetail:\nEmail: " +
      email;
...
function setup() {
  ...
  SCRIPT_PROP.setProperty(
    "1wGns6nmPqiFEY9WutHzALfv7qkt1gdxzIp6ARVAhwi0",
    doc.getId()
  );
}
/**
...
function uploadFileToGoogleDrive(data, file, nama, email, e) {
  try {
    var dropbox = "Foto Barang Bergerak";
    var folder,
