function doPost(e) {
  try {
    ...
    var message =
      "Halo, Ada pengambilan barang di Gudang/Warehouse Workshop PPI https://docs.google.com/spreadsheets/d/1imeih-ZmdF8pW_Bz7GTCRkYO_BF_cggj6o_Bjebbxsw/edit#gid=0\n\nDetail:\nEmail: " +
      email;
...
function setup() {
  ...
  SCRIPT_PROP.setProperty(
    "1imeih-ZmdF8pW_Bz7GTCRkYO_BF_cggj6o_Bjebbxsw",
    doc.getId()
  );
}
/**
...
function uploadFileToGoogleDrive(data, file, nama, email, e) {
  try {
    var dropbox = "Foto Barang Tidak Bergerak";
    var folder,
